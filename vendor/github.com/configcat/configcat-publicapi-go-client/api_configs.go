...
/*
ConfigsApiService Create Config
...
@return ConfigModel
*/
func (a *ConfigsApiService) CreateConfig(ctx context.Context, body CreateConfigRequest, productId string) (ConfigModel, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/products/{productId}/configs"
...
/*
ConfigsApiService Delete Config
This endpoint removes a Config identified by the &#x60;configId&#x60; parameter.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param configId The identifier of the Config.

*/
func (a *ConfigsApiService) DeleteConfig(ctx context.Context, configId string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/configs/{configId}"
...
/*
ConfigsApiService Get Config
This endpoint returns the metadata of a Config identified by the &#x60;configId&#x60;.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param configId The identifier of the Config.
@return ConfigModel
*/
func (a *ConfigsApiService) GetConfig(ctx context.Context, configId string) (ConfigModel, *http.Response, error) {
	var (
...
/*
ConfigsApiService List Configs
...
/*
ConfigsApiService Update Config
...
@return ConfigModel
*/
func (a *ConfigsApiService) UpdateConfig(ctx context.Context, body UpdateConfigRequest, configId string) (ConfigModel, *http.Response, error) {
	var (
