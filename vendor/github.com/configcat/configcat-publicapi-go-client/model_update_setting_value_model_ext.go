...
type UpdateSettingValueModelBool struct {
...
type UpdateSettingValueModelString struct {
	// The targeting rule collection.
...
type UpdateSettingValueModelInt struct {
	// The targeting rule collection.
...
type UpdateSettingValueModelFloat struct {
	// The targeting rule collection.
