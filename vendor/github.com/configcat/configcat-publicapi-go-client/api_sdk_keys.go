...
@return SdkKeysModel
*/
func (a *SDKKeysApiService) GetSdkKeys(ctx context.Context, configId string, environmentId string) (SdkKeysModel, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/configs/{configId}/environments/{environmentId}"
