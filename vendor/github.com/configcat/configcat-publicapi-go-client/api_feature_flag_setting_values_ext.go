...
*/
func (a *FeatureFlagSettingValuesApiService) GetSettingValueSimple(ctx context.Context, environmentId string, settingId int32) (SettingValueSimpleModel, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue SettingValueSimpleModel
	)
