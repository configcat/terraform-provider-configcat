  ...
  targeting_rules = [
    {
      ...
      value = { predefined_variation_id = configcat_setting.string_setting.predefined_variations[1].predefined_variation_id }
    }
  ]
}
  ...
  targeting_rules = [
    {
      percentage_options = [
        ...
        {
          percentage = 90
          value      = { predefined_variation_id = configcat_setting.int_setting.predefined_variations[1].predefined_variation_id }
        }
      ]
    }
  ]
      ...
      conditions = [
        {
          prerequisite_flag_condition = {
            prerequisite_setting_id = configcat_setting.bool_setting.id
            comparator              = "equals"
            comparison_value        = { predefined_variation_id = configcat_setting.bool_setting.predefined_variations[1].predefined_variation_id }
          }
        }
      ]
      percentage_options = [
        ...
        {
          percentage = 90
          value      = { predefined_variation_id = configcat_setting.double_setting.predefined_variations[1].predefined_variation_id }
        }
      ]
    }
  ]
