		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testResourceName, PermissionGroupApprovalPermissionType, "canBypassApproval"),
					resource.TestCheckResourceAttr(testResourceName, PermissionGroupNewEnvironmentApprovalType, "canBypassApproval"),
					resource.TestCheckResourceAttr(testResourceName, PermissionGroupEnvironmentApprovals+".%", "0"),
			...
			},
			{
				...
				ConfigVariables: config.Variables{
					"product_id":               config.StringVariable(productId),
					"name":                     config.StringVariable("Resource name"),
					"approval_permission_type": config.StringVariable("custom"),
					"new_environment_approval_permission_type": config.StringVariable("canApproveOthers"),
					"environment_approval_permissions": config.MapVariable(map[string]config.Variable{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrSet(testResourceName, ID),
					resource.TestCheckResourceAttr(testResourceName, Name, "Resource name"),
					resource.TestCheckResourceAttr(testResourceName, PermissionGroupApprovalPermissionType, "custom"),
					resource.TestCheckResourceAttr(testResourceName, PermissionGroupNewEnvironmentApprovalType, "canApproveOthers"),
					resource.TestCheckResourceAttr(testResourceName, PermissionGroupEnvironmentApprovals+".%", "1"),
					resource.TestCheckResourceAttr(testResourceName, PermissionGroupEnvironmentApprovals+"."+environment1Id, "cannotApprove"),
				),
			},
			{
				ConfigFile: config.TestNameFile("main.tf"),
				ConfigVariables: config.Variables{
					"product_id":               config.StringVariable(productId),
					"name":                     config.StringVariable("Resource name"),
					"approval_permission_type": config.StringVariable("readOnly"),
					"environment_approval_permissions": config.MapVariable(map[string]config.Variable{
						environment1Id: config.StringVariable("cannotApprove"),
					}),
				},
				ExpectError: regexp.MustCompile(`invalid value 'readOnly' for ApprovalPermissionType`),
			},
			{
				ConfigFile: config.TestNameFile("main.tf"),
				ConfigVariables: config.Variables{
					"product_id":               config.StringVariable(productId),
					"name":                     config.StringVariable("Resource name"),
					"approval_permission_type": config.StringVariable("canApproveOthers"),
					"environment_approval_permissions": config.MapVariable(map[string]config.Variable{
						environment1Id: config.StringVariable("cannotApprove"),
					}),
				},
