...
func TestAccSettingValueIntResource(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testResourceName, SettingValue, "2"),
			...
			},
			{
				...
				ConfigVariables: config.Variables{
					"config_id":      config.StringVariable(configId),
					"environment_id": config.StringVariable(environmentId),
					"value":          config.StringVariable("3"),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrSet(testResourceName, ID),
					resource.TestCheckResourceAttr(testResourceName, SettingValue, "3"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+".#", "0"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+".#", "0"),
				),
			},
			...
			},
			{
				...
				ConfigVariables: config.Variables{
					"config_id":        config.StringVariable(configId),
					"environment_id":   config.StringVariable(environmentId),
					"value":            config.StringVariable("4"),
					"percentage1":      config.StringVariable("5"),
					"percentage2":      config.StringVariable("6"),
					"percentage3":      config.StringVariable("89"),
					"percentage1value": config.StringVariable("6"),
					"percentage2value": config.StringVariable("7"),
					"percentage3value": config.StringVariable("8"),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrSet(testResourceName, ID),
					resource.TestCheckResourceAttr(testResourceName, SettingValue, "4"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+".#", "0"),
					...
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[0]."+RolloutPercentageItemValue, "6"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[1]."+RolloutPercentageItemPercentage, "6"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[1]."+RolloutPercentageItemValue, "7"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[2]."+RolloutPercentageItemPercentage, "89"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[2]."+RolloutPercentageItemValue, "8"),
				),
			},
			{
				ConfigFile: config.TestNameFile("with_percentage.tf"),
			...
			},
			{
				...
				ConfigVariables: config.Variables{
					"config_id":        config.StringVariable(configId),
					"environment_id":   config.StringVariable(environmentId),
					"value":            config.StringVariable("5"),
					"percentage1":      config.StringVariable("10"),
					"percentage2":      config.StringVariable("20"),
					"percentage3":      config.StringVariable("70"),
					"percentage1value": config.StringVariable("10"),
					"percentage2value": config.StringVariable("11"),
					"percentage3value": config.StringVariable("12"),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrSet(testResourceName, ID),
					resource.TestCheckResourceAttr(testResourceName, SettingValue, "5"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+".#", "0"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+".#", "3"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[0]."+RolloutPercentageItemPercentage, "10"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[0]."+RolloutPercentageItemValue, "10"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[1]."+RolloutPercentageItemPercentage, "20"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[1]."+RolloutPercentageItemValue, "11"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[2]."+RolloutPercentageItemPercentage, "70"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[2]."+RolloutPercentageItemValue, "12"),
				),
			},
			{
				ConfigFile: config.TestNameFile("with_percentage.tf"),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrSet(testResourceName, ID),
					resource.TestCheckResourceAttr(testResourceName, SettingValue, "20"),
					...
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+"[0]."+RolloutRuleValue, "30"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+".#", "0"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+"[0]."+RolloutRuleComparator, "contains"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+"[0]."+RolloutRuleComparisonValue, "@configcat.com"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+"[0]."+RolloutRuleValue, "5"),
					...
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+"[1]."+RolloutRuleValue, "6"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+".#", "0"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrSet(testResourceName, ID),
					resource.TestCheckResourceAttr(testResourceName, SettingValue, "40"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+".#", "2"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+"[0]."+RolloutRuleComparisonAttribute, "email"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+"[0]."+RolloutRuleComparator, "contains"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+"[0]."+RolloutRuleComparisonValue, "@configcat.com"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+"[0]."+RolloutRuleValue, "50"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+"[1]."+RolloutRuleComparisonAttribute, "color"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+"[1]."+RolloutRuleComparator, "isOneOf"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+"[1]."+RolloutRuleComparisonValue, "red"),
					resource.TestCheckResourceAttr(testResourceName, RolloutRules+"[1]."+RolloutRuleValue, "60"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+".#", "3"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[0]."+RolloutPercentageItemPercentage, "10"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[0]."+RolloutPercentageItemValue, "70"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[1]."+RolloutPercentageItemPercentage, "20"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[1]."+RolloutPercentageItemValue, "80"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[2]."+RolloutPercentageItemPercentage, "70"),
					resource.TestCheckResourceAttr(testResourceName, RolloutPercentageItems+"[2]."+RolloutPercentageItemValue, "90"),
				),
			},
			{
				ConfigFile: config.TestNameFile("with_rules_and_percentage.tf"),
