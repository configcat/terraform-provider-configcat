		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr(testResourceName, RolloutRules+".0."+RolloutRuleComparisonAttribute),
					resource.TestCheckNoResourceAttr(testResourceName, RolloutRules+".0."+RolloutRuleComparator),
					resource.TestCheckNoResourceAttr(testResourceName, RolloutRules+".0."+RolloutRuleComparisonValue),
				),
			},
			{
				ConfigFile: config.TestNameFile("one_rule.tf"),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr(testResourceName, RolloutRules+".1."+RolloutRuleSegmentComparator),
					resource.TestCheckNoResourceAttr(testResourceName, RolloutRules+".1."+RolloutRuleSegmentId),
					...
					resource.TestCheckNoResourceAttr(testResourceName, RolloutRules+".2."+RolloutRuleComparisonAttribute),
					resource.TestCheckNoResourceAttr(testResourceName, RolloutRules+".2."+RolloutRuleComparator),
					resource.TestCheckNoResourceAttr(testResourceName, RolloutRules+".2."+RolloutRuleComparisonValue),
				),
			},
			{
				ConfigFile: config.TestNameFile("multiple_rules.tf"),
