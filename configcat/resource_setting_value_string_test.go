		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(TEST_RESOURCE, SETTING_TYPE, "string"),
					resource.TestCheckResourceAttr(TEST_RESOURCE, SETTING_VALUE, "test1"),
					checkTest1Value,
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet(TEST_RESOURCE, "id"),
					resource.TestCheckResourceAttr(TEST_RESOURCE, SETTING_TYPE, "string"),
					resource.TestCheckResourceAttr(TEST_RESOURCE, SETTING_VALUE, "test2"),
					checkTest1Value,
				),
			},
		},
